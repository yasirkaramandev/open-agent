...
export type ScientificAction =
  | { type: 'function'; name: 'sin' | 'cos' | 'tan' | 'asin' | 'acos' | 'atan' | 'ln' | 'log10' | 'sqrt' }
  | { type: 'square' }
  | { type: 'power' }
  | { type: 'reciprocal' }
  | { type: 'factorial' }
...
const keys: ReadonlyArray<{
  ...
  { visual: 'tan', label: 'Tangent', action: { type: 'function', name: 'tan' } },
  { visual: 'sin⁻¹', label: 'Inverse sine', action: { type: 'function', name: 'asin' } },
  { visual: 'cos⁻¹', label: 'Inverse cosine', action: { type: 'function', name: 'acos' } },
  { visual: 'tan⁻¹', label: 'Inverse tangent', action: { type: 'function', name: 'atan' } },
  { visual: 'ln', label: 'Natural logarithm', action: { type: 'function', name: 'ln' } },
  { visual: 'log', label: 'Base ten logarithm', action: { type: 'function', name: 'log10' } },
  { visual: '√x', label: 'Square root', action: { type: 'function', name: 'sqrt' } },
  ...
  { visual: 'e', label: 'Euler’s number', action: { type: 'constant', name: 'e' } },
];
